...
public final class Indexer {
    ...
    private void processModule(DataInputStream data, ClassInfo target) throws IOException {
        if (!target.isModule()) {
            throw new IllegalStateException("Module attributed appeared in a non-module class file");
        }
        ...
        // Store the owning ClassInfo using the modules name instead of `module-info`
    ...
    private void processModulePackages(DataInputStream data, ClassInfo target) throws IOException {
        if (!target.isModule()) {
            throw new IllegalStateException("ModulePackages attributed appeared in a non-module class file");
        }
    ...
    private void processModuleMainClass(DataInputStream data, ClassInfo target) throws IOException {
        if (!target.isModule()) {
            throw new IllegalStateException("ModuleMainClass attributed appeared in a non-module class file");
        }
